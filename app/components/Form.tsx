    ...
    return (
        <div className={'w-full rounded-lg p-3 sm:p-8 flex flex-col gap-5 form-bg'}>
            <div className={'flex flex-col gap-2'}>
                ...
                <input placeholder={'Your Name'} className={'bg-white sm:text-xl font-light text-sm text-white focus:outline-0 placeholder:text-opacity-50 bg-opacity-10 p-5 rounded-full h-14'}></input>
            </div>
            <div className={'flex flex-col gap-2'}>
                <p className={'pl-5 text-white font-light opacity-50 text-md'}>Email</p>
                <input placeholder={'Your Email'} className={'bg-white sm:text-xl font-light text-sm text-white focus:outline-0 placeholder:text-opacity-50 bg-opacity-10 p-5 rounded-full h-14'}></input>
            </div>
            <div className={'flex flex-col gap-2'}>
            ...
            <div className={'flex flex-col gap-2'}>
                ...
                <input placeholder={'Company name'} className={'bg-white sm:text-xl font-light text-sm text-white focus:outline-0 placeholder:text-opacity-50 bg-opacity-10 p-5 rounded-full h-14'}></input>
            </div>
            <div className={'flex flex-col gap-2'}>
