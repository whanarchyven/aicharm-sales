                ...
                <div className={'w-full h-full items-center px-[20px] sm:sm:max-w-[1440px]'}>
                    ...
                    <div className={'mt-6 grid grid-cols-2 gap-8'}>
                        <div className={'flex flex-col w-full '}>
                            ...
                            <div className={'pl-10 mt-4 py-6 border-2 border-black border-opacity-10 rounded-xl'}>
                                <div className={''}>
                                    <div className={'flex gap-3 items-start'}>
                                        <div className={'w-[5%] flex justify-start'}>
                                ...
                                <div className={'flex flex-col w-[95%] gap-3'}>
                                    ...
                                    <div className={'grid grid-cols-7 items-start gap-1'}>
                                        ...
                                        <div className={'col-span-5 flex items-center gap-3 w-full text-sm'}>
                                            <div className={'px-4 py-1 bg-[#1DAEFF] text-white rounded-full flex items-center justify-center'}>
                                                Trait #1
                                            </div>
                                            <div className={'px-4 py-1 bg-[#71E884] text-white rounded-full flex items-center justify-center'}>
                                                Trait #2
                                            </div>
                                            <div className={'px-4 py-1 bg-[#FF7B7B] text-white rounded-full flex items-center justify-center'}>
                                                Trait #3
                                            </div>
                                        </div>
                                    </div>
                                    <div className={'grid grid-cols-1 items-start gap-1'}>
                                        ...
                                        <div className={' w-full text-sm'}>
                                            <p className={'text-lg whitespace-pre-wrap font-light'}>1.Some text that explains Psychological Profile of the Client <br/>
                                ...
                                <div className={'flex gap-3 items-start'}>
                                    ...
                                    <div className={'flex flex-col w-[95%] gap-3'}>
                                        ...
                                        <div className={'flex mt-4 items-center gap-3'}>
                                            <p className={'text-orange text-2xl leading-[100%] font-bold'}>Client-Manager Match</p>
