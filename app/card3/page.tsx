        ...
        <main className="bg-black w-full">
            ...
            <div className={'w-full flex justify-center sm:px-12 bg-white bg-cover relative py-44'}>
                <div className={'w-full h-full items-center px-[20px] sm:sm:max-w-[1440px]'}>
                    ...
                    <div className={'mt-6 grid border-b-2 border-black border-opacity-10 grid-cols-2 gap-8'}>
                        <div className={'flex flex-col w-full py-8 '}>
                            ...
                            <div className={'flex gap-3 mt-6 items-start'}>
                                ...
                                <div className={'flex flex-col w-[95%] gap-3'}>
                                    <p className={'text-orange text-2xl leading-[100%] font-bold'}>Conversation
                                        Summary:</p>
                                    <WrapP
                        ...
                        <div className={'flex flex-col w-full pl-8 py-8 border-black border-opacity-10'}>
                            <div className={'pl-10 py-6 border-2 border-black border-opacity-10 rounded-xl'}>
                                <div className={''}>
                                    <div className={'flex gap-3 items-start'}>
                                        <div className={'w-[5%] flex justify-start'}>
                            ...
                            <div className={'mt-4 pl-20'}>
                                <div className={'flex mt-4 items-center gap-3'}>
                                    <p className={'text-orange text-2xl leading-[100%] font-bold'}>Client-Manager
                                        Match</p>
                                    <img
                                        className={'opacity-20 hover:opacity-100 cursor-pointer duration-300 transition-all'}
                                        src={'/card/icons/info_black.svg'}/>
                                </div>
                                <img className={'w-4/5'} src={'/card/match.svg'}/>
                            </div>
                        </div>
                    </div>


                    <div className={'grid border-black border-opacity-10 grid-cols-2 gap-8'}>
                        <div className={'flex mt-8 gap-3 items-start'}>
                            <div className={'w-[5%] flex justify-start'}>
                                <img className={'w-6 aspect-square'} src={'/card/icons/client.svg'}/>
                            </div>
                            <div className={'flex flex-col w-[95%] gap-3'}>
                                <p className={'text-orange text-2xl leading-[100%] font-bold'}>Client Profile and
                                    State:</p>
                                <div className={'flex gap-4  items-center'}>
                                    <p className={'text-black text-3xl font-bold'}>Client Name</p>
                                    <div className={'px-4 py-2 gap-3 flex items-center rounded-full bg-[#1DAEFF]'}>
                                        <p className={'text-white font-bold'}>ENTJ</p>
                                        <img
                                ...
                                <div className={'grid grid-cols-7 items-start gap-1'}>
                                    ...
                                    <div className={'col-span-5 w-full text-sm'}>
                                        <p className={'text-lg font-light'}>[Client&apos;s Emotional State, e.g., Interested,
                                            Curious]</p>
                                    </div>
                                </div>
                                <div className={'grid grid-cols-7 items-start gap-1'}>
                                ...
                                <div className={'grid grid-cols-7 items-start gap-1'}>
                                    ...
                                    <div className={'col-span-5 flex items-center gap-3 w-full text-sm'}>
                                        <div
                                            className={'px-4 py-1 bg-[#1DAEFF] text-white rounded-full flex items-center justify-center'}>
                                            Trait #1
                                        </div>
                                        <div
                                            className={'px-4 py-1 bg-[#71E884] text-white rounded-full flex items-center justify-center'}>
                                            Trait #2
                                        </div>
                                        <div
                                            className={'px-4 py-1 bg-[#FF7B7B] text-white rounded-full flex items-center justify-center'}>
                                            Trait #3
                                        </div>
                                    </div>
                                </div>
                                <div className={'grid grid-cols-1 mt-8 items-start gap-1'}>
                                    <p className={'text-black text-lg font-bold'}>Psychological Profile of the
                                        Client:</p>
                                    <div className={' w-full text-sm'}>
                                        <p className={'text-lg whitespace-pre-wrap font-light'}>1.Some text that
                                ...
                                <div className={'flex mt-8 items-center gap-3'}>
                                    <p className={'text-orange text-2xl leading-[100%] font-bold'}>Client emotions</p>
                                    <img
                                        className={'opacity-20 hover:opacity-100 cursor-pointer duration-300 transition-all'}
                                        src={'/card/icons/info_black.svg'}/>
                                </div>
                                <img className={'w-3/5'} src={'/card/emotions.svg'}/>
                            </div>
                        </div>

                        <div className={'flex flex-col w-full p-8 border-l-2 border-black border-opacity-10'}>
                            <div className={'flex flex-col items-start gap-4'}>
                                ...
                                <div className={'flex pl-[7%] flex-col'}>
                                    ...
                                    <div className={'grid grid-cols-7 mt-3 items-start gap-1'}>
                                        <p className={'text-black col-span-2 text-lg font-bold'}>Client&apos;s Traits:</p>
                                        <div className={'col-span-5 flex items-center gap-3 w-full text-sm'}>
                                            <div
                                                className={'px-4 py-1 bg-[#1DAEFF] text-white rounded-full flex items-center justify-center'}>
                            ...
                            <div className={'mt-6'}>
                                <div className={'flex gap-3 items-start'}>
                                    ...
                                    <div className={'flex flex-col w-[95%] gap-3'}>
                                        <p className={'text-orange text-2xl leading-[100%] font-bold'}>Manager&apos;s
                                            Performance
                                            Assessment:</p>
                                    </div>
                                </div>
                            ...
                            <div className={'mt-6'}>
                                <div className={'flex gap-3 items-start'}>
                                    ...
                                    <div className={'flex flex-col w-[95%] gap-3'}>
                                        <p className={'text-orange text-2xl leading-[100%] font-bold'}>Psychological
